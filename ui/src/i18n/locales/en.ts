...
export const en: TranslationMap = {
  ...
  subtitles: {
    agents: "Your AI assistants and their settings.",
    builder: "Describe what you need and let EasyClaw build it.",
    templates: "Ready-made agent blueprints to get started fast.",
    overview: "Dashboard status and system health.",
    onboarding: "Step-by-step setup for AI providers and messaging.",
    advanced: "Low-level runtime, config, automation, and diagnostics.",
    channels: "Messaging apps and communication settings.",
    instances: "Devices and apps connected to your gateway.",
    sessions: "Conversation history and active sessions.",
    usage: "Track AI usage and costs.",
    cron: "Tasks that run on a schedule or timer.",
    skills: "Capabilities and API keys for your agents.",
    nodes: "Paired devices and remote access.",
    chat: "Chat directly with your AI agent.",
    config: "Advanced configuration settings.",
    communications: "Messaging, audio, and notification settings.",
    appearance: "Theme, layout, and display preferences.",
    automation: "Scheduled tasks, plugins, and integrations.",
    infrastructure: "Network, gateway, and media settings.",
    aiAgents: "AI models, memory, and agent behavior.",
    debug: "System diagnostics and event history.",
    logs: "Live system activity logs.",
  },
  overview: {
    access: {
    ...
    stats: {
      instances: "Connections",
      instancesHint: "Active devices in the last 5 minutes.",
      sessions: "Sessions",
      sessionsHint: "Recent conversations tracked by the gateway.",
      cron: "Scheduled",
