...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    builder: "Describe an agent and let easyclaw shape the blueprint.",
    templates: "Agent blueprints and starter templates.",
    overview: "Status, entry points, health.",
    onboarding: "Guided setup for channels, AI, and integrations.",
