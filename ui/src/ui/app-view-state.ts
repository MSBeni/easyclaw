...
export type AppViewState = {
  ...
  builderApplyResult: import("./controllers/builder.ts").BuilderApplyResult | null;
  ...
  templatesPlan: import("./controllers/templates.ts").TemplatePlanResult | null;
  templatesPlanLoading: boolean;
  templatesPlanError: string | null;
  templatesApplyResult: import("./controllers/templates.ts").TemplateApplyResult | null;
