    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <details style="margin-top: 6px">
          <summary style="cursor: pointer; font-size: 12px; color: var(--accent);">Show terminal commands</summary>
      ...
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <details style="margin-top: 6px">
            <summary style="cursor: pointer; font-size: 12px; color: var(--accent);">Show terminal commands</summary>
            <div style="margin-top: 4px">
              <span class="mono">openclaw dashboard --no-open</span> &rarr; get tokenized URL<br />
              <span class="mono">openclaw doctor --generate-gateway-token</span> &rarr; generate token
            </div>
          </details>
          <div style="margin-top: 6px">
            <a
