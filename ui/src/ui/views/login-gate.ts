    ...
    <div class="login-gate">
      ...
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="EasyClaw" />
          <div class="login-gate__title">EasyClaw</div>
          <div class="login-gate__sub">Create agents for anyone, effortlessly.</div>
        </div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="EASYCLAW_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>${t("overview.connection.step1")}<code>easyclaw gateway run</code></li>
            <li>${t("overview.connection.step2")}<code>easyclaw dashboard --no-open</code></li>
