...
export class OpenClawApp extends LitElement {
  ...
  @state() builderApplyResult: import("./controllers/builder.ts").BuilderApplyResult | null = null;
  ...
  @state() templatesCatalogError: string | null = null;
  @state() templatesPlan: import("./controllers/templates.ts").TemplatePlanResult | null = null;
  @state() templatesPlanLoading = false;
  @state() templatesPlanError: string | null = null;
  @state() templatesApplyResult: import("./controllers/templates.ts").TemplateApplyResult | null =
    null;
  @state() templatesApplying = false;
  @state() templatesApplyError: string | null = null;
  @state() templatesVariables: Record<string, string> = {};
